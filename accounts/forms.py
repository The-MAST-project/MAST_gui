...
class RegistrationForm(forms.ModelForm):
    ...
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(attrs={"placeholder": "name@institution.edu", "autocomplete": "email"}),
    )

    prefix = forms.CharField(
        label=_("Prefix"), max_length=32, required=False, help_text=_("Optional: e.g. Dr, Prof, Mr, Mrs")
    )
    ...
    first_name = forms.CharField(
        ...
        max_length=100,
        required=True,
        widget=forms.TextInput(attrs={"placeholder": "John", "autocomplete": "given-name"}),
    )
    ...
    last_name = forms.CharField(
        ...
        widget=forms.TextInput(attrs={"placeholder": "Smith", "autocomplete": "family-name"}),
    )
    ...
    institution = forms.CharField(
        ...
        widget=forms.TextInput(attrs={"placeholder": "Weizmann Institute of Science", "autocomplete": "organization"}),
    )
    ...
    department = forms.CharField(
        ...
        widget=forms.TextInput(attrs={"placeholder": "Particle Physics and Astrophysics"}),
    )
    ...
    orcid = forms.CharField(
        ...
        widget=forms.TextInput(attrs={"placeholder": "0000-0002-1825-0097", "pattern": ORCID_REGEX}),
    )
    ...
    research_interests = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={"rows": 3, "placeholder": "e.g., Time-domain astronomy, spectroscopy of transients, stellar evolution"}
        ),
    )
    ...
    country = forms.CharField(
        ...
        widget=forms.TextInput(attrs={"placeholder": "Israel", "autocomplete": "country-name"}),
    )
    ...
    additional_info = forms.CharField(
        ...
        widget=forms.Textarea(attrs={"rows": 3, "placeholder": "e.g., Collaboration details, project information"}),
    )
    ...
    agree_citation = forms.BooleanField(
        ...
        required=True,
        error_messages={"required": _("Citation agreement is required")},
    )
...
class LocalSignupForm(UserCreationForm):
    ...
    class Meta(UserCreationForm.Meta):
        model = User
        fields = ("email", "first_name", "last_name", "affiliation", "phone", "country", "city", "password1", "password2")


class ProfileForm(forms.ModelForm):
    prefix = forms.CharField(max_length=32, required=False, label="Prefix", help_text="e.g. Dr, Prof, Mr, Mrs")
