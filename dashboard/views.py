...
def index(request):
    ...
    try:
        ...
        if not site:
            return render(request, "dashboard/index.html", {"error": f"Site {current_site} not found"})
        ...
        return render(
            request, "dashboard/index.html", {"site": site, "units_status": units_status, "current_site": current_site}
        )

    except Exception as e:
        logger.error(f"Error loading dashboard: {e}")
        return render(request, "dashboard/index.html", {"error": "Error loading dashboard data"})
