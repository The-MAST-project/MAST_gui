...
def admin_user_delete(request, user_id):
    ...
    try:
        ...
        try:
            ...
            user.save()
            messages.warning(
                request, f"Cannot delete user {username} (has protected related data). User has been deactivated."
            )
            return render(request, "admin/partials/user_row.html", {"user": user})
...
def admin_group_edit(request, group_id):
    ...
    return render(
        request,
        "admin/partials/group_edit_modal.html",
        {
            "edit_group": group,
...
def admin_group_delete_modal(request, group_id):
    ...
    return render(
        request,
        "admin/partials/group_delete_modal.html",
        {
            "group": group,
...
def ownerships_assets(request):
    ...
    return render(
        request,
        "admin/partials/ownership_assets.html",
        {
            "from_user": from_user,
            "assets": assets,
        },
...
def debug_cache(request):
    ...
    cache_data = {"last_refresh": MastCache().last_refresh, "ttl": MastCache().ttl, "status": status_data}
...
def refresh_cache_endpoint(request):
    ...
    data = {"success": success, "timestamp": MastCache().last_refresh, "has_status": MastCache().sites_status is not None}
