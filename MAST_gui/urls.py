...
urlpatterns = [
    ...
    path("scheduling/single/sun-curve/", views.scheduling_sun_curve, name="scheduling_sun_curve"),
    path("scheduling/single/sun-position/", views.scheduling_sun_position, name="scheduling_sun_position"),
    ...
    path(
        "manage/users/<int:user_id>/deactivate-modal/",
        accounts_views.admin_deactivate_user_modal,
        name="admin_deactivate_user_modal",
    ),
